...
window.addEventListener("load", () => {
  ...
  document.querySelector("#calc-direct").addEventListener("click", () => {
  ...
  document.querySelector("#calc-then").addEventListener("click", () => {
    resultElement.innerHTML = "Начались вычисления";
    console.log("before Promise");
    let promise = new Promise((resolve) => resolve(callChebyshev()));
